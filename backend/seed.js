...
// ── MOBILE IMAGES (curated Unsplash IDs) ──────────────────────────────────────
const mobileImages = {
    iphone: [
        u('1592899677977-9c10ca588bbd'), u('1510557880182-3d4d3cba35a5'),
        u('1574755393849-d29ab9dbc6b9'), u('1585060544812-6b45742d762f')
    ],
    samsung: [
        u('1610945265064-0e34e5519bbf'), u('1587829741301-dc798b83add3'),
        u('1546954907-3a50cd0e3bb2'), u('1555487505-8603a1a69755')
    ],
    google: [
        u('1598327105666-5b89351aff23'), u('1607936854526-f8b4e76a5b50'),
        u('1511707171634-5f897ff02aa9'), u('1616348436168-de43ad0db364')
    ],
    oneplus: [
        u('1636496224984-be84a9c07a22'), u('1629571534922-d5e1edcede82'),
        u('1544244015-0df4b3ffc6b0'), u('1587742177015-1b22a0e3f0f0')
    ],
    xiaomi: [
        u('1551355738-1875b4b5e4e3'), u('1585060544812-6b45742d762f'),
        u('1519163703-d69e83a0c13b'), u('1546954907-3a50cd0e3bb2')
    ],
    sony: [
        u('1511707171634-5f897ff02aa9'), u('1598327105666-5b89351aff23'),
        u('1616348436168-de43ad0db364'), u('1587829741301-dc798b83add3')
    ],
    nothing: [
        u('1574755393849-d29ab9dbc6b9'), u('1510557880182-3d4d3cba35a5'),
        u('1607936854526-f8b4e76a5b50'), u('1636496224984-be84a9c07a22')
    ],
    asus: [
        u('1555487505-8603a1a69755'), u('1610945265064-0e34e5519bbf'),
        u('1629571534922-d5e1edcede82'), u('1519163703-d69e83a0c13b')
    ],
    motorola: [
        u('1587742177015-1b22a0e3f0f0'), u('1544244015-0df4b3ffc6b0'),
        u('1551355738-1875b4b5e4e3'), u('1592899677977-9c10ca588bbd')
    ],
    realme: [
        u('1546954907-3a50cd0e3bb2'), u('1636496224984-be84a9c07a22'),
        u('1574755393849-d29ab9dbc6b9'), u('1555487505-8603a1a69755')
    ],
    oppo: [
        u('1629571534922-d5e1edcede82'), u('1511707171634-5f897ff02aa9'),
        u('1610945265064-0e34e5519bbf'), u('1587829741301-dc798b83add3')
    ],
    vivo: [
        u('1519163703-d69e83a0c13b'), u('1551355738-1875b4b5e4e3'),
        u('1585060544812-6b45742d762f'), u('1607936854526-f8b4e76a5b50')
    ]
};

const getMobileImages = (name) => {
    const lower = name.toLowerCase();
    if (lower.includes('iphone')) return mobileImages.iphone;
    if (lower.includes('samsung')) return mobileImages.samsung;
    if (lower.includes('google') || lower.includes('pixel')) return mobileImages.google;
    if (lower.includes('oneplus')) return mobileImages.oneplus;
    if (lower.includes('xiaomi')) return mobileImages.xiaomi;
    if (lower.includes('sony')) return mobileImages.sony;
    if (lower.includes('nothing')) return mobileImages.nothing;
    if (lower.includes('asus')) return mobileImages.asus;
    if (lower.includes('motorola')) return mobileImages.motorola;
    if (lower.includes('realme')) return mobileImages.realme;
    if (lower.includes('oppo')) return mobileImages.oppo;
    if (lower.includes('vivo')) return mobileImages.vivo;
    return mobileImages.samsung;
};

const mobileNames = [
    'iPhone 16 Pro Max', 'Samsung Galaxy S25 Ultra', 'Google Pixel 10 Pro', 'OnePlus 14 Pro',
    'Xiaomi 15 Ultra', 'Sony Xperia 1 VII', 'Nothing Phone 4 Pro', 'Asus ROG Phone 10',
    'Motorola Edge 60 Ultra', 'Realme GT 6 Pro', 'Oppo Find X9 Pro', 'Vivo X300 Pro',
    'iPhone 16 Pro', 'Samsung Galaxy Z Fold 7', 'Google Pixel 10', 'OnePlus 13',
    'Xiaomi 15 Pro', 'Sony Xperia 5 VII', 'Nothing Phone 3a'
];
...
async function seedDB() {
    try {
        ...
        console.log(`🚀 Seeded ${products.length} products with realistic images!`);
